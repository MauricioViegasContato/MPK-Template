...
## Como Rodar
1.  Renomeie o projeto e configure seu próprio projeto no Supabase.
2.  Atualize as chaves em `lib/core/config/app_config.dart`.
3.  Execute `flutter run`.

---
**Desenvolvido por:** [Maurício Viégas](https://mauricioviegas.vercel.app/)
